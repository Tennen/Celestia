...
- [Project Touchpoints API](api/touchpoints.md): `/api/v1/touchpoints` input mappings, WeCom users/menu/ingress, voice transcription provider, and project input flow
- [Agent Runtime API](api/agent.md): `/api/v1/agent` Eino ReAct runtime, conversation, memory, search logs, topic, writing, market, evolution, terminal, Codex, and renderer operations
