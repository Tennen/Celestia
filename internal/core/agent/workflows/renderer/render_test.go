...
func TestRendererCommandRewritesBundledRelativePath(t *testing.T) {
	command := rendererCommand("node internal/core/agent/workflows/renderer/md2img/render.mjs", "/repo/internal/core/agent/workflows/renderer/md2img/render.mjs")
	if !strings.Contains(command, "/repo/internal/core/agent/workflows/renderer/md2img/render.mjs") {
...
func TestRendererCommandRewritesOldBundledPath(t *testing.T) {
	command := rendererCommand("node internal/core/agent/md2img/render.mjs", "/repo/internal/core/agent/workflows/renderer/md2img/render.mjs")
...
func TestRendererCommandPreservesCustomCommand(t *testing.T) {
	command := rendererCommand("node /opt/renderers/custom.mjs", "/repo/internal/core/agent/workflows/renderer/md2img/render.mjs")
