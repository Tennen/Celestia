...
type Service interface {
	...
	ListAgentTools(ctx context.Context) ([]models.AgentToolInfo, error)
	DescribeAgentTool(ctx context.Context, name string) (models.AgentToolInfo, error)
	RunAgentTool(ctx context.Context, name string, req models.AgentToolRunRequest) (models.AgentToolRunResult, error)
	SaveAgentWorkflow(ctx context.Context, workflow models.AgentWorkflowSnapshot) (models.AgentSnapshot, error)
	RunAgentWorkflow(ctx context.Context, workflowID string) (models.AgentWorkflowRun, error)
