...
type Service interface {
	...
	ListAgentCapabilities(ctx context.Context) ([]models.AgentCapabilityInfo, error)
	DescribeAgentCapability(ctx context.Context, name string) (models.AgentCapabilityInfo, error)
	RunAgentCapability(ctx context.Context, name string, req models.AgentCapabilityRunRequest) (models.AgentCapabilityRunResult, error)
