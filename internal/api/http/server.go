...
func New(addr string, runtime *runtimepkg.Runtime) *Server {
	...
	mux.HandleFunc("PUT /api/v1/automations/{id}", s.handleUpdateAutomation)
	mux.HandleFunc("DELETE /api/v1/automations/{id}", s.handleDeleteAutomation)
	...
	mux.HandleFunc("POST /api/v1/touchpoints/wecom/menu/publish", s.handleAgentWeComMenuPublish)
	...
	mux.HandleFunc("GET /api/v1/agent/capabilities", s.handleAgentCapabilities)
	mux.HandleFunc("GET /api/v1/agent/capabilities/{name}", s.handleAgentCapability)
	mux.HandleFunc("POST /api/v1/agent/capabilities/{name}/run", s.handleAgentCapabilityRun)
	mux.HandleFunc("PUT /api/v1/agent/topic", s.handleAgentTopicSave)
	mux.HandleFunc("POST /api/v1/agent/topic/run", s.handleAgentTopicRun)
