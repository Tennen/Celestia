...
func New(addr string, runtime *runtimepkg.Runtime) *Server {
	...
	mux.HandleFunc("PUT /api/v1/agent/direct-input", s.handleAgentDirectInput)
	mux.HandleFunc("PUT /api/v1/agent/push", s.handleAgentPush)
	mux.HandleFunc("PUT /api/v1/agent/wecom/menu", s.handleAgentWeComMenu)
	mux.HandleFunc("POST /api/v1/agent/wecom/menu/publish", s.handleAgentWeComMenuPublish)
	mux.HandleFunc("POST /api/v1/agent/wecom/send", s.handleAgentWeComSend)
	mux.HandleFunc("POST /api/v1/agent/wecom/image", s.handleAgentWeComImage)
	mux.HandleFunc("POST /api/v1/agent/wecom/callback", s.handleAgentWeComCallback)
	mux.HandleFunc("POST /api/v1/agent/wecom/ingress", s.handleAgentWeComIngress)
