...
// DeviceSnapshot holds a complete point-in-time view of a Petkit device.
...
// DeviceOccurredEvent holds a device-level event extracted from feeder records.
...
// PetkitFamily holds the device and pet lists for a Petkit family group.
type PetkitFamily struct {
	DeviceList []PetkitDeviceInfo
	PetList    []PetkitPetInfo
}

// PetkitPetInfo holds basic pet metadata.
